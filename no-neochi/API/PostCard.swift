...
struct PostCard {
    ...
    func request(handler: @escaping ResultHandler<()>) {
        ...
        let param: Parameters =  ["token": "64353366383264373439383762656536373466653665323765646234616133393734616535623463666235333136383031323861346462393730363332336630"]
